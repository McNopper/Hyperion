...
if(NOT WIN32 AND NOT CMAKE_SYSTEM_NAME STREQUAL "Linux")
    message(FATAL_ERROR "Hyperion supports only Windows and Linux.")
endif()

function(hyperion_configure_target target)
    ...
    if(WIN32)
        target_compile_definitions(${target} INTERFACE
            NOMINMAX
            WIN32_LEAN_AND_MEAN
            HYPERION_PLATFORM_WINDOWS=1
        )
    else()
        target_compile_definitions(${target} INTERFACE HYPERION_PLATFORM_LINUX=1)
    endif()
endfunction()
