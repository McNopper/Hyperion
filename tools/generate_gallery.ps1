# Generate the 30-scene screenshot gallery (Hyperion: 64 spp, 1280×720).
# Usage: .\tools\generate_gallery.ps1 [-Renderer path\to\hyperion.exe] [-OutputDir screenshots]
param(
    [string]$Renderer = "build\hyperion.exe",
...
foreach ($scene in $scenes) {
    ...
    & $Renderer --scene $scene --spp $Spp --width $Width --height $Height `
