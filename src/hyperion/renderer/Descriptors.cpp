...
VkResult Descriptors::updateSceneSet(const DeviceContext& ctx, const Scene& scene) {
    ...
    const std::array writes{
        VkWriteDescriptorSet{VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET,
                             nullptr, m_set1, 0, 0, 1, VK_DESCRIPTOR_TYPE_STORAGE_BUFFER,
                             nullptr, &bufferInfos[0], nullptr},
        VkWriteDescriptorSet{VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET,
                             nullptr, m_set1, 1, 0, 1, VK_DESCRIPTOR_TYPE_STORAGE_BUFFER,
                             nullptr, &bufferInfos[1], nullptr},
        VkWriteDescriptorSet{VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET,
                             nullptr, m_set1, 2, 0, 1, VK_DESCRIPTOR_TYPE_STORAGE_BUFFER,
                             nullptr, &bufferInfos[2], nullptr},
        VkWriteDescriptorSet{VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET,
                             nullptr, m_set1, 3, 0, 1, VK_DESCRIPTOR_TYPE_STORAGE_BUFFER,
                             nullptr, &bufferInfos[3], nullptr},
        VkWriteDescriptorSet{VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET,
                             nullptr, m_set1, 5, 0, 1, VK_DESCRIPTOR_TYPE_STORAGE_BUFFER,
                             nullptr, &bufferInfos[4], nullptr},
    };
