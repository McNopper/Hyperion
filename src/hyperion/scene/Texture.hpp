...
[[nodiscard]] inline TextureColorSpace parseTextureColorSpace(std::string_view name) noexcept {
    if (name == "srgb_texture") return TextureColorSpace::SrgbTexture;
    if (name == "lin_srgb")     return TextureColorSpace::LinSrgb;
    if (name == "lin_rec2020")  return TextureColorSpace::LinRec2020;
    if (name == "acescg" || name == "lin_ap1") return TextureColorSpace::AcesCg;
